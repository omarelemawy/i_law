...
class PublishersListScreen extends StatefulWidget {
  const PublishersListScreen({Key? key}) : super(key: key);

  @override
  _PublisherListScreenState createState() => _PublisherListScreenState();
}

class _PublisherListScreenState extends State<PublishersListScreen> {
  @override
      ...
      body: Column(
        children: [
          Row(
            children: [
              SizedBox(width: 20,),
              Text(getTranslated(context, "Publishers")!,
                style: TextStyle(
                color: Colors.black,
