...
class AllSubCategoryList extends StatefulWidget {
  const AllSubCategoryList({Key? key}) : super(key: key);

  @override
  _SubCategoryListScreenState createState() => _SubCategoryListScreenState();
}

class _SubCategoryListScreenState extends State<AllSubCategoryList> {
  @override
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            Text(getTranslated(context, "Sub Categories")!,style: TextStyle(
                fontSize: 34,
                color: Colors.black,
